...
2. Add a dated entry to `knowledge/ledger.md` using the ledger schema, including "Explain it like I'm 10" — a plain-words, jargon-free, concrete-comparison summary of what actually happened, written first.
